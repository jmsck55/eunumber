...
? b
d = AddExp(c[1], c[2], c[5][1], c[5][2], 10, defaultBase)
? d

d = AddExp(c[1], c[2], c[5][1], c[5][2], 4, defaultBase)
? d
d = AddExp(c[5][1], c[5][2], c[1], c[2], 5, defaultBase)
? d

trace(1)

d = SubtractExp(c[1], c[2], -c[5][1], c[5][2], 10, defaultBase)
? d
d = SubtractExp(-c[1], c[2], c[5][1], c[5][2], 10, defaultBase)
? d
